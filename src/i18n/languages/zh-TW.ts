...
export const zhTW: Translation = {
    ...
    [Key.wallpaperFullscreen]: "全屏壁紙",
    [Key.wallpaperBanner]: "橫幅壁紙",
    ...
    [Key.rssCopied]: "RSS 鏈接已復制到剪貼板！",
    [Key.rssCopyFailed]: "復制失敗，請手動復制鏈接",
    ...
    [Key.atomWhatIsAtomDescription]: "Atom聯合格式（Atom Syndication Format）是一個基於XML的標準，用於描述訂閱源及其信息項。通過 Atom，你可以：",
    ...
    [Key.atomCopied]: "Atom 鏈接已復制到剪貼板！",
    [Key.atomCopyFailed]: "復制失敗，請手動復制鏈接",

    // 密碼保護
    [Key.passwordProtected]: "密碼保護",
    [Key.passwordProtectedTitle]: "此內容受密碼保護",
    [Key.passwordProtectedDescription]: "請輸入密碼以查看受保護的内容",
